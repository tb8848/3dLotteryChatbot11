...
//              ex.printStackTrace();
    ...
    public static void main(String[] args) {
        String token = JwtUtil.generToken("1", null, null);
        System.out.println(token);

        System.out.println(JwtUtil.getUsername("eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIxNTk0NjI5NjQxMjAyNzY1ODI1IiwiaWF0IjoxNjY5Mjc3NTYwLCJleHAiOjE2NzE4Njk1NjB9.4sE01V_oq5nqrkse2htLce4jcwCQbDAvBXLoYu9_isc"));
        //System.out.println(c);

        /*String s = "2022-11-17 17:25:42";

        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
        LocalDateTime ldt = LocalDateTime.parse(s, formatter);
        LocalDateTime now = LocalDateTime.now();
        System.out.println(Math.abs(ChronoUnit.MINUTES.between(ldt, now)));

        Calendar instance = Calendar.getInstance();
        instance.add(Calendar.MINUTE , -1);
        SimpleDateFormat sdf = new SimpleDateFormat("yyy-MM-dd HH:mm:ss") ;
        String t = sdf.format(instance.getTime()) ;
