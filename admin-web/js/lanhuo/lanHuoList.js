        ...
        table.render({
            ...
            cols: [
                [
                    ...
                    {field: 'printId',title: i18np.prop('lanhuo.table.head.printId'),align: 'center',totalRowText: i18np.prop('lanhuo.table.total')},
                    {field: 'vipName',title: i18np.prop('lanhuo.table.head.member'),align: 'center'},
                    {field: 'createTime',title: i18np.prop('lanhuo.table.head.orderTime'),align: 'center'},
                    {field: 'buyCodes',title: i18np.prop('lanhuo.table.head.codes'),align: 'center', templet: function (d) {
                            if (d.hasOneFlag == 1) {
                    ...
                    {field: 'huizongName',title: "下注说明",align: 'center'}
                ]
            ],
            page: true
            ,page: {
