...
const vm = new Vue({
    ...
    methods: {
        ...
        saveEdit(){//保存修改
            ...
            var params = {};
            if(this.oddsType == 0){
                url = HOST+'fpPeiRate/user/update';
                params = {
                    editList:editList,
                    editUserOddsList:editList,
                    syncList:syncList,
                    userId:that.userId
                }
            }else{
        ...
        getDatas(){
            ...
            if(this.oddsType == 0) {
                url = HOST + 'fpPeiRate/user/listAll?lotterySettingId=' + that.lsId+"&userId="+that.userId;
            }else {
