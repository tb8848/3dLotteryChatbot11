...
const vm = new Vue({
    ...
    methods: {
        ...
        initDataList(page) {
            const _this = this;
            layer.msg(_this.$t('select.dataLoading'),{
                time:-1,
                icon:16,
                shade:0.3
            })
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.code == 0) {
                        ...
                        _this.selfTotalReturnWater = res.data.selfTotalReturnWater
                        _this.sfSx = res.data.sfsx
                        _this.zs = res.data.zs
