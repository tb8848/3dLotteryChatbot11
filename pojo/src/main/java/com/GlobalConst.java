...
public class GlobalConst {
    ...
    public static String[] keywords1 = {"单选","直选普通","直选和值","直选","直组","直","通选","分笔组三","分笔组六","分笔复式","组三和值","组三飞","组三组六","组3组6","组三",
            "双飞组三","组六和值","组六飞","组六","双飞组六","包选三","包选六","和数","和","1D","猜1D","2D","猜2D","大小","大","小","奇偶","奇","偶","拖拉机","三同号",
            "猜三同","跨度","跨","3D","P3","复式","独胆","胆","独","单","复","组3飞","组3","组6飞","组6","一定","二定","XX","X","**","*","百",",","，","."};


    public static String[] keywords2 = {"福","体","单选","直选","直组","直","分笔组三","分笔组六","分笔复式","组三飞","组三组六","组3组6","组三","双飞组三","组六飞","组六",
            "双飞组六","和数","和","1D","2D","大小","大","小","奇偶","奇","偶","拖拉机","三同号","猜三同","跨度","跨","3D","P3","复式","独胆","胆","独","单","复","组3飞",
