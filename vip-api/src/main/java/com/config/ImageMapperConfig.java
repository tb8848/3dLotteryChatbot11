...
public class ImageMapperConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/pdf/**").addResourceLocations("file:" + upload + "pdf/").setCachePeriod(31556926).resourceChain(true).addResolver(versionResourceResolver);;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(apiInterceptor).addPathPatterns("/vip/**").excludePathPatterns(Arrays.asList("/admin/**/*.css","/admin/**/*.js","/admin/**/*.gif","/admin/**/*.png","/admin/**/*.jpg","/admin/**/*.html"));
    }
}
