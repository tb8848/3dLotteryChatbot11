...
public class RandomNameUtil {
    ...
    public static void main(String[] args) {
        /*String liangzi = randomName(true,2);
        String sanzi = randomName(false,3);
        String sizi = randomName(false,4);
        System.err.println("两字昵称："+liangzi+"\n"+"三字昵称："+sanzi+"\n"+"四字昵称："+sizi);
        String nick = generateNickname(1);
    ...
    public static String generateNickname(int type) {

        String[] nicks = {"淡笑凡尘", "少女七分熟", "猫扑风铃", "廸迦！變裑！", "字句皆是你", "我会慢慢长大", "被窝探险家", "究竟有多冷漠", "她的风骚", "我学不来", "薄情眉", "一身傲骨不服输"
                , "天空的蓝", "一种忧伤", "高冷低能儿", "七分饶幸", "兰陵王", "不太乖", "长不大的小祸害", "小祸害", "小鹿别撞啦", "Keen(精明)", "草的时节", "用你的手挖我的心", "骚气外露"
                , "霸气外露", "憨气外漏", "孤独的像野狗", "孤独的像野猫", "小螃蟹的一员", "抓不住爱情的猪", "抓不住爱情的傻子", "小雨的告白", "风的告白", "随风飘扬", "奔跑", "温柔且奶凶"
                , "奶熊姐", "奶凶姐", "奶凶妹", "哈萨", "南拥夏栀", "短回忆的鱼", "鱼", "小泽", "阿彪", "尔康", "鲸落", "碧落黄泉", "穷碧落", "小少爷", "泽大少", "狗蛋", "自南书余生"
                , "南阳", "卧龙", "凤雏", "独步校园", "独步逍遥", "珴芯疼的厲害", "古剑奇谭", "矢心疯", "他罘在乎峩", "等待没了期待", "泰山府君", "小程仙君", "用情深至到无情", "相思无人探"
                , "九劫曲", "诅咒之地", "海王哥哥", "刺眼的暧昧", "放肆的温柔", "维“我”命", "峩の傷", "风带走故事", "带走你", "风间次郎", "拥抱孤独", "结网捕鱼", "授人以渔", "授人以鱼"
                , "瞩目之星", "光辉岁月", "Karry(开瑞)", "逆光下的微笑", "月亮不干饭", "干饭人", "干饭魂", "拿可爱换你", "总有逗比挑衅朕", "月舞云袖", "喜你入三分", "欲言竟无", "互相伤害"
                , "跳海自尽的鱼", "起飞的鸟", "深蓝北斗星", "高冷孤独我的范", "仰起头不流泪", "把酒临风", "把酒言欢", "小狐仙", "对酒当歌", "人生几何", "所谓伊人", "蒹葭", "在水一方", "伊人泪"
                , "轩辕破天", "楚春秋", "人憔悴", "遇见星空", "沁园春", "北国风光", "千里冰封", "万里雪飘", "长城内外", "山舞银蛇", "江山", "英雄", "秦皇汉武", "唐宗宋祖", "詹太青", "诸葛孔明"
                , "地狱不空", "诸葛青", "王爷", "王也", "宝儿姐", "最终boss", "天一", "雀巢", "易水寒", "左手指月", "口蜜腹剑", "任我行", "樱木花道", "流川枫", "剑仙", "刀线", "我必逆天"
                , "一剑破天", "一剑开天门", "一代天骄", "绾鸢", "陌雨夕", "枫溪", "像从前几分", "纵情犯", "落暮伊人", "槿笙", "苍苍蒹葭", "伊人白霜", "软萌仙女", "暖男", "扛着感情", "扛着爱情"
                , "她如薄荷凉我心", "平生一顾", "不打感情牌", "心有猛虎", "细嗅蔷薇", "花の痕", "温声软语", "嘴角向上", "憋说话，吻我", "寂月灭影", "涟潇花霰颜姬", "绝世舞姬", "臣妾", "朕emo了"
                , "啸月天狼", "闪耀的银狼", "沙漠之寂", "鬼疑神迷", "鱼雁音书", "醉看明月", "半冷半酷半成熟", "倾城如泪", "笙歌云上", "清风无痕", "念卿天涯", "一念天堂", "记忆零碎", "佛魔纪元"
                , "龙战天涯", "龙战于野", "逆战", "唯美上天", "一曲琵琶倾城梦", "一帘幽梦", "冷夜残月", "幻化成风", "流绪微梦", "狂灵在世", "秀你一脸", "梦影逍遥", "风寒影", "寒影绝", "眉间长风"
                , "岁月无垠", "羽逸之光", "一生笑傲", "笑傲江湖", "汐剑云", "魔鬼中的天使", "武穹", "情是海洋", "酷酷的网名", "酷酷的眼神", "落花时节", "落花有意", "一剑缥缈", "指天", "血溅江湖"
                , "孤山远影", "寒江孤影", "江湖故人", "何必曾相识", "点灭百城", "忧伤成海", "南皇", "玉皇", "炎帝", "符祖", "大主宰", "石昊", "最爱喝兽奶", "小情绪", "小朋友", "森林屿麓"
                , "聆听风音", "暗恋未遂", "离歌", "邈姒殇", "姬王殇", "傲世狂天", "暧昧黑魔", "如火夜魅", "月痕迹", "幻化成蝶", "苏苏啵啵哒", "冷眸里的傲", "落雨流", "暴雨梨花针", "佛怒唐莲"
                , "佛怒火莲", "龙傲★巅峰", "浅蓝三色堇", "素衣风尘叹", "紫魅柔情", "冷清清", "灰白色的回想", "佩奇大哥", "墨伊筱夕", "硪清高自傲", "初心亦凡", "高冷女子", "相思满惆怅", "魂毒"
                , "千里追风", "血花飞舞", "纯洁的梦", "武碎玄空", "烟雨飘渺", "寒霜", "暗夜丿影枫泠", "迷途不归家", "血染★傲世", "壹身傲", "北城不夏", "无限战火", "骑着毛驴上高速", "雪橇三傻"
                , "回忆如风", "回忆总想哭", "昙花未现", "狗不理", "烟尘花锁眉", "烟火里的尘埃", "雨眼汨", "醉笑清风", "梦里花落", "陈影", "少年放肆的梦", "一叶知秋", "迷路的喵咪", "姐拽的有气质"
                , "时光若止", "姐就是女王", "傲慢公主", "泣血无", "雨凉念秋", "逆心者", "残花碎情衷", "一秒哀痛", "少年纪", "半透明色", "回忆de旋律", "汐宸轩", "音梦", "像场烂电影", "习惯了寂寞"
                , "指尖流沙", "夜晚", "夜", "头顶的云", "心殇", "南音少女", "浪漫哥哥", "那y抹阳光", "散落的唯美", "竹琳听雨", "哑紫风铃", "情", "昨日", "轻衣白衫", "往复随安", "触碰灵魂"
                , "梦中沙迷眼", "倾你一世温柔", "半宛清愁", "受萌若惊", "谦谦世界", "一个人的浪漫", "孤傲的灵魂", "向往自由", "冷月孤星", "一念成佛", "一念成魔", "熹微已旧", "夏", "雨打芭蕉残"
                , "忧歌落", "一夕承诺", "小颖", "永远的夜幕", "相思", "相思落无声", "低的身", "茉莉小仙女", "思君令人老", "素酒青衣贤", "栀子花", "红颜多妖孽", "阳光天使", "白马", "梦境de欢影"
                , "戒不掉殇", "残蝉躁晚", "这样的帅气", "帅气", "花开花落", "情缠三生", "帅气的男人", "精神小伙", "张大仙", "小泽学长", "小泽仙君", "魂风尖上", "旧景依旧", "野兽之瞳", "追风"
                , "初心未改", "颜汐", "逸", "影", "雨敲疏棂", "素流年", "流年", "忆红颜", "回眸", "无悔的天涯", "耀世天下", "茫然光流逝", "潇", "潇潇", "彩鳞", "古族", "魂族", "萧族"
                , "少女范", "盛夏光年", "天使之梦", "天鹅之梦", "翩若惊鸿", "惊鸿", "动若游龙", "静若处子", "动若脱兔", "皇者何畏", "日不西沉", "龙凤堂", "空城旧戏", "陌初寒上", "南风与歌"
                , "红尘悲痛", "寻梦旅人", "征战途", "墨雨云烟", "过眼云烟", "朝如青丝暮成雪", "别情", "北柠陌寒", "如歌黑白", "蔸蔸里有颗糖", "老衲法号帅哥", "深深深", "森林牧歌", "雨中飞鸟"
                , "艺坛翘楚", "紫鸢情", "帅的有格调", "月影依风", "月下影相随", "罂花", "次元人类", "玩命丕玩", "女叫兽", "腿短任性", "与风奔跑", "随风奔跑", "夜的海", "残梦断忆", "品茗听雪"
                , "似水流年", "梦魁", "此男人已疯", "莫阡陌", "思念", "夏慕槿苏", "一季烟雨凉", "玲珑宝贝", "不屑回眸", "无知的代价", "古谚喋夙", "蓝魅", "蓝娇", "仙女抱喵", "高姿美女", "萌面侠"
                , "古月存风", "顾影自怜", "少年歌行", "秋思", "秋月心", "梦情", "南柯一梦", "清凉一夏", "青帝山", "放晴的天空", "圣城中州", "萧舞天", "小雅", "橘子郡主", "冰月灵狐", "煎饼侠"
                , "南池姑娘", "不败的蔷薇", "半夜童话", "人间四月天", "小仙女", "月清", "一蓑烟雨", "仗剑走天涯", "九霄山河", "凌云志", "少年时", "不死天宫", "十绝体", "灵眸", "不死冥王体"
                , "天龙皇", "炎黄子孙", "炎皇", "栖凤", "鸢飞", "猿飞", "无天剑皇", "三生魔帝", "封魔大帝", "仰天望月", "牵黄擎苍", "醉花阴", "指尖韶华", "飞花似梦", "天涯行客", "天凉好个秋"
                , "天上的星星", "天台", "天天开心", "笔上山海", "清晨的牛奶", "万里顾一程", "一枝梅", "黑夜太漫长", "江户川", "每天收米", "沉淀", "二向箔", "沐沐", "非常完美", "大碗先生"
                , "浮生若梦", "无声飞雪", "断桥残雪", "无齿的人", "呆到深处自然萌", "各不打扰", "倔强先生", "浅笑", "小老弟", "红豆", "萌小萌", "时光荏苒", "捂不热的心", "草编戒指", "萧玄"
                , "谁伴我闯荡", "污界扛把子", "逆流成河", "世态炎凉", "神泣百花殇", "社会这么乱", "凉了夏天", "久孤成疾", "青衫故人", "抹茶布丁", "不承诺", "油炸小可爱", "黑白键", "转身再见"
                , "谈情不如逗狗", "心为你跳动", "花醉三千客", "无叶之秋", "流萤逐风", "风萧萧", "一切免谈", "只手遮天", "古惑仔", "情场浪子", "佛系少女", "小怪兽", "狂飙", "霸王花", "灵梦"
                , "我的天空", "撩汉小仙女", "初夏的忧伤", "看你背影", "爱吃西瓜子", "孤独是种安全感", "终究错过", "野花丛里", "不眠之夜", "天际征鸿", "脂红粉白", "雾里寻你", "眼前人心上人"
                , "亦心", "爱你爱到后退", "好梦不及重温", "天马", "白羊", "狮子座", "射手座", "金牛座", "開心就好", "南山南", "一曲流年", "爱到骨子里", "撩妹局局长", "没有时间", "忘记时间"
                , "兔牙萝莉", "精致", "种草莓", "梦摇醒了", "起风了", "人影憧", "做个俗人", "青山", "青山不改", "绿水长流", "清明河图", "笑春风", "殺死喜欢", "佛系女孩", "四起狼烟", "狼烟起"
                , "眸中星", "心上人", "狙击", "沾花惹草", "说爱你", "总裁娇妻", "时而懒", "大风吹", "太多的想念", "诱惑糖果", "朝暮如", "闻到春归去", "春运", "不二臣", "颜末", "甜味", "饮浊酒"
                , "动感超人", "少年瞳", "夜猫情", "温柔野", "青衫明眸", "春江花月夜", "日和月", "生命在於戰鬥", "君思君", "几何原本", "眼里只有你", "面朝大海", "春暖花开", "池鱼故渊", "难再遇"
                , "空城", "旧人的心", "人間正道是滄桑", "月老", "早川", "荧光棒会发光", "人情世故", "三世劫", "九生情", "卖胭脂", "一个人", "人生作儿戏", "九龙天噬", "成长牛奶", "十年一觉", "小熊"
                , "大白兔奶糖", "别太在乎", "因为爱上你", "成了仙的猪", "暗黑小小兔", "狙击手", "熊扑熊抱", "堕落", "北街浊酒", "跑调情话", "趣味之交", "大人世界", "浪漫主义", "少女渣渣", "不羁而行"
                , "不曾停息", "真江南", "往生門", "见南山", "忙着可爱", "我不是你爹", "神明", "酒精泡芙", "枕边人", "怀中猫", "古道边上", "月下人不归", "春去春来", "不思量", "自难忘", "二八佳人"
                , "长安故里", "放手", "等对的人相逢", "音乱少女", "千里共婵娟", "山水相逢", "游戏人间", "心里有囍", "江小鱼", "自闭症少女", "如花似锦", "微风依旧", "柔情千种", "下落不详", "乏味"
                , "渴望长命百岁", "恩爱变为仇", "共酩酊", "浅唱入君心", "风花雪月", "山河表里", "大佬的女人", "娇娘艳客", "乐曲", "不羡江中仙", "不羡仙", "不羡鸳鸯", "仙猪", "君卿", "旧胶片"
        };
        String[] adjectives = {"高兴的", "有趣的", "疯狂的", "糊涂的", "无聊的", "精神的", "粗俗的", "奇特的", "善良的", "闪亮的", "开朗的", "功夫", "好", "长不大的", "不太乖的"};
        String[] nouns = {"小猫", "小狗", "小鸟", "鱼儿", "熊猫", "狮子", "大象", "猴子", "企鹅", "阿彪", "小泽", "尔康", "阿波罗", "君君", "强哥", "丹丹", "兄弟"};
...
//        System.out.println("昵称数量："+nicks.length);
        String nick = nicks[rand.nextInt(nicks.length)];
        return nick;
    }
