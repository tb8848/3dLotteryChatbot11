...
@Deprecated
@Component
public class P3BotWechatMQService {
    ...
    private Logger logger = LoggerFactory.getLogger(P3BotWechatMQService.class);
     ...
     * @param channel
     */
//    @RabbitListener(queues = "bot_wechat_queue_p3")
//    public void recvMessage(Message msg, final Channel channel) throws IOException {
//        String body = new String(msg.getBody());
//        logger.info("【P3】收到微信状态消息>>>>>>>>"+body);
//        String lockKey = "p3:chatbot:wechat:mq";
