...
public class DrawBuyRecordService extends ServiceImpl<DrawBuyRecordDAO, DrawBuyRecord> {
    ...
    public Map<String, Object> getDrawRecordByCodes (String drawId, Draw draw,Integer lotteryType) {
        ...
        query2.eq(DrawBuyRecord::getBuyType, lotteryType);
        ...
        query3.in(DrawBuyRecord::getHuizongFlag, Lists.newArrayList("0", "-1"));
        query3.eq(DrawBuyRecord::getBuyCodes, draw.getDrawResult());
        query3.eq(DrawBuyRecord::getBuyType, lotteryType);
        ...
        if (count == 2) { // 有重号
            ...
            query5.eq(DrawBuyRecord::getBuyType, lotteryType);
            query5.in(DrawBuyRecord::getLotterSettingId, Lists.newArrayList("55", "56", "57", "58", "59", "60", "61", "62", "63", "64",
            ...
            query12.eq(DrawBuyRecord::getBuyType, lotteryType);
            ...
            query5.eq(DrawBuyRecord::getBackCodeFlag, 0);
            query5.eq(DrawBuyRecord::getDrawId, drawId);
            query5.in(DrawBuyRecord::getLotterSettingId, Lists.newArrayList("73", "74", "75", "76", "77", "78", "79", "80", "81", "82", "83",
                    "84", "85", "86", "87", "88", "89", "90", "91", "92", "93", "94", "95", "96", "18"));
            query5.eq(DrawBuyRecord::getBuyType, lotteryType);
            query5.in(DrawBuyRecord::getHuizongFlag, Lists.newArrayList("0", "-1"));
            ...
            if (!z6List.isEmpty()) {
                for (DrawBuyRecord drawBuyRecord : z6List) {
                    ...
                    }else if (countSame == 2 && drawBuyRecord.getLotterSettingId().equals("73")) { // 双飞组六
                        LambdaUpdateWrapper<DrawBuyRecord> uw = new LambdaUpdateWrapper();
                        uw.set(DrawBuyRecord::getDrawStatus,1);
                        uw.set(DrawBuyRecord::getDrawLotteryFlag,1);
                        BigDecimal odds = new BigDecimal(drawBuyRecord.getParam3());
        ...
        //query6.in(DrawBuyRecord::getLotterSettingId, Lists.newArrayList("23", "26", "5"));
        query6.in(DrawBuyRecord::getLotterSettingId, Lists.newArrayList("23", "26"));
        query6.eq(DrawBuyRecord::getParam2, sum.toString());
        query6.eq(DrawBuyRecord::getBuyType, lotteryType);
        ...
        queryHs.eq(DrawBuyRecord::getBuyType, lotteryType);
        ...
        query8.eq(DrawBuyRecord::getBuyType, lotteryType);
        ...
        query9.eq(DrawBuyRecord::getBuyType, lotteryType);
        query9.in(DrawBuyRecord::getHuizongFlag, Lists.newArrayList("0", "-1"));
        ...
        query10.eq(DrawBuyRecord::getBuyType, lotteryType);
        ...
        query11.eq(DrawBuyRecord::getBuyType, lotteryType);
        ...
        query13.eq(DrawBuyRecord::getBuyType, lotteryType);
        ...
        if (tljFlag) {
            ...
            query14.eq(DrawBuyRecord::getBuyType, lotteryType);
        ...
        queryKd.eq(DrawBuyRecord::getBuyType, lotteryType);
        ...
        query15.eq(DrawBuyRecord::getBuyType, lotteryType);
