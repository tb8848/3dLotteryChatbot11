...
public class KuaidaBuyMsgServiceV2 {
    ...
    //快打下注，固定文本格式
    public void kuaidaBuy(ChatRoomMsg fromMsg, BotUser botUser, Player player,Integer lotteryType){
        try {
            Draw draw = null;
    ...
    private void xiazhu(BotUser botUser, Player player,ChatRoomMsg fromMsg,
        ...
        if(player.getPretexting()==1 || player.getEatPrize()==1){
            ...
            if("5".equals(lmId) || "13".equals(lmId)){
                ...
                buyResult = buyRecord3DServiceV2.codesBatchBuy(player,buyList,draw,-2,null,msg,lotteryType);
            }
