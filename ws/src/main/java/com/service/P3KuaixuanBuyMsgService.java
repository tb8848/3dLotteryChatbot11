...
public class P3KuaixuanBuyMsgService extends ServiceImpl<ChatRoomMsgDAO, ChatRoomMsg> {
    ...
    public void xiazhu(ChatRoomMsg msg,BotUser botUser,Player player){
        ...
        if("5".equals(lmId) || "13".equals(lmId)){
            buyResult = buyRecord3DService.buy3dHs(player,buyList,draw,-2,null,msg.getMsg(),2);
        }else{
            buyResult = buyRecord3DService.codesBatchBuy(player,buyList,draw,-2,null,msg.getMsg(),2);
        }
